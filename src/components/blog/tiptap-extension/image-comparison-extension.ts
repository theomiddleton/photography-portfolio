    ...
    return [
      ...
      displayMode === 'side-by-side' ? [
        ...
        [
          ...
          ...(showLabels ? [[
            'div',
            { class: 'absolute left-2 top-2 rounded bg-black/70 px-2 py-1 text-sm text-white' },
            'Before',
          ]] : []),
          ...(beforeImage.caption ? [[
            'div',
        ...
        [
          ...
          ...(showLabels ? [[
            'div',
            { class: 'absolute right-2 top-2 rounded bg-black/70 px-2 py-1 text-sm text-white' },
            'After',
          ]] : []),
          ...(afterImage.caption ? [[
            'div',
        ...
        [
          ...
          ...(beforeImage.caption ? [[
            'div',
            { class: 'absolute bottom-8 left-2 rounded bg-black/70 px-2 py-1 text-sm text-white' },
        ...
        [
          ...
          'div',
          {
            class: 'comparison-after-image absolute inset-0 overflow-hidden',
          ...
          ...(afterImage.caption ? [[
            'div',
            { class: 'absolute bottom-8 right-2 rounded bg-black/70 px-2 py-1 text-sm text-white' },
        ...
        [
          ...
          [
            'div',
            { class: 'absolute inset-2 rounded-full bg-gray-400' },
          ],
        ],
        ...(showLabels ? [
          [
