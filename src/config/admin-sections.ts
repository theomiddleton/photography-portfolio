import { ImageIcon, PenIcon, InfoIcon, StoreIcon, UserIcon, HomeIcon, LogOutIcon, BookOpenText, TrashIcon } from 'lucide-react'
...
export const adminSections = [
  ...
  { title: 'Delete', description: 'Delete an image', icon: TrashIcon, href: '/admin/delete'},
