...
export const adminSections = [
  ...
  { title: 'Main Gallery', description: 'Configure main gallery layout, features, and settings', icon: SettingsIcon, href: '/admin/gallery-config'},
  { title: 'Multi-Gallery Pages', description: 'Create pages with multiple gallery sections', icon: GalleryThumbnailsIcon, href: '/admin/multi-galleries'},
